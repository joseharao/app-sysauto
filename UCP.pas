...
procedure TfrmCP.btBaixarClick(Sender: TObject);
var
  Str, Data : String;
begin
  inherited;
...
procedure TfrmCP.btGravarClick(Sender: TObject);
begin
...
procedure TfrmCP.btNovoClick(Sender: TObject);
begin
  inherited;
  cdsTabCOD_REC.AsInteger := PegaSequencia('GEN_CP_ID');
...
procedure TfrmCP.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
